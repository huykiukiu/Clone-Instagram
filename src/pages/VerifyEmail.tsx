...
export default function VerifyEmail() {
  ...
  return (
    <div className="bg-black min-h-svh flex justify-center items-center">
      <div className="w-full max-w-md bg-[#18181b] rounded-lg p-8">
        ...
        <div className="text-center">
          {status === "loading" && (
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-white text-lg">Đang xác thực email của bạn...</p>
            </div>
          )}
          ...
          {status === "success" && (
            <div className="flex flex-col items-center gap-4">
              ...
              <h2 className="text-white text-2xl font-bold">Xác thực thành công!</h2>
          ...
          {status === "error" && (
            <div className="flex flex-col items-center gap-4">
              ...
              <h2 className="text-white text-2xl font-bold">Xác thực thất bại!</h2>
