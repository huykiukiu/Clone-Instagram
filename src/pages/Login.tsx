...
export default function Login() {
  ...
  const loginRequest = useAuth((state) => state.login);
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div className="bg-black min-h-svh flex justify-center items-center gap-50">
      <div>
        <img src="login.png" alt="login image" className="max-w-130" />
      </div>
      <div className="w-full max-w-75">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button className="bg-blue-900 hover:bg-blue-800 text-white font-bold w-full h-10 rounded-md cursor-pointer">
            Đăng nhập
          </button>
        </form>
