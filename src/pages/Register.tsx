...
export default function Register() {
  ...
  return (
    <div className="bg-black min-h-svh flex justify-center items-center gap-50">
      <div>
        <img src="login.png" alt="register image" className="max-w-130" />
      </div>
      <div className="w-full max-w-75">
        ...
        <h2 className="text-center text-gray-400 text-lg mb-5">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-3">
            <input
              type="email"
              className="bg-[#25292e] text-white w-full h-10 rounded-xs px-3 outline-none"
              placeholder="Email"
              autoFocus
              {...register("email")}
            />
            {errors.email?.message && (
              <h3 className="text-red-500 text-sm mt-1">
                {errors.email.message}
              </h3>
            )}
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="bg-blue-900 hover:bg-blue-800 text-white font-bold w-full h-10 rounded-md cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? "Đang đăng ký..." : "Đăng ký"}
          </button>
        </form>

        <p className="text-gray-400 text-xs text-center my-5">
          Bằng cách đăng ký, bạn đồng ý với{" "}
          <span className="text-blue-500 cursor-pointer">Điều khoản</span>,{" "}
        ...
        <div className="flex flex-col justify-center items-center gap-3">
          <div className="cursor-pointer">
            ...
            <span className="text-blue-500">Đăng nhập bằng Facebook</span>
          </div>
        </div>

        <div className="mt-6 text-center">
          <span className="text-white">Bạn có tài khoản? </span>
